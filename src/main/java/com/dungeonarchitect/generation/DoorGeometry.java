...
public final class DoorGeometry {
    ...
    private static IntVector3 alignedOrigin(BoundingBox3i slotBounds, Direction3 facing, BoundingBox3i relativeDoorBounds, BoundingBox3i relativeGatewayBounds) {
        return switch (facing) {
            case NORTH -> new IntVector3(centeredAxisOrigin(slotBounds.min().x(), slotBounds.max().x(), relativeDoorBounds.min().x(), relativeDoorBounds.max().x(), relativeGatewayBounds.min().x(), relativeGatewayBounds.max().x()), bottomAlignedAxisOrigin(slotBounds.min().y(), slotBounds.max().y(), relativeDoorBounds.min().y(), relativeDoorBounds.max().y(), relativeGatewayBounds.min().y(), relativeGatewayBounds.max().y()), slotBounds.min().z() - relativeGatewayBounds.min().z());
            case SOUTH -> new IntVector3(centeredAxisOrigin(slotBounds.min().x(), slotBounds.max().x(), relativeDoorBounds.min().x(), relativeDoorBounds.max().x(), relativeGatewayBounds.min().x(), relativeGatewayBounds.max().x()), bottomAlignedAxisOrigin(slotBounds.min().y(), slotBounds.max().y(), relativeDoorBounds.min().y(), relativeDoorBounds.max().y(), relativeGatewayBounds.min().y(), relativeGatewayBounds.max().y()), slotBounds.max().z() - relativeGatewayBounds.max().z());
            case EAST -> new IntVector3(slotBounds.max().x() - relativeGatewayBounds.max().x(), bottomAlignedAxisOrigin(slotBounds.min().y(), slotBounds.max().y(), relativeDoorBounds.min().y(), relativeDoorBounds.max().y(), relativeGatewayBounds.min().y(), relativeGatewayBounds.max().y()), centeredAxisOrigin(slotBounds.min().z(), slotBounds.max().z(), relativeDoorBounds.min().z(), relativeDoorBounds.max().z(), relativeGatewayBounds.min().z(), relativeGatewayBounds.max().z()));
            case WEST -> new IntVector3(slotBounds.min().x() - relativeGatewayBounds.min().x(), bottomAlignedAxisOrigin(slotBounds.min().y(), slotBounds.max().y(), relativeDoorBounds.min().y(), relativeDoorBounds.max().y(), relativeGatewayBounds.min().y(), relativeGatewayBounds.max().y()), centeredAxisOrigin(slotBounds.min().z(), slotBounds.max().z(), relativeDoorBounds.min().z(), relativeDoorBounds.max().z(), relativeGatewayBounds.min().z(), relativeGatewayBounds.max().z()));
    ...
    private static int bottomAlignedAxisOrigin(int slotMin, int slotMax, int doorMin, int doorMax, int gatewayMin, int gatewayMax) {
        if (doorMax - doorMin <= slotMax - slotMin) {
            return slotMin - doorMin;
        }
        return centeredAxisOrigin(slotMin, slotMax, doorMin, doorMax, gatewayMin, gatewayMax);
    }
}
